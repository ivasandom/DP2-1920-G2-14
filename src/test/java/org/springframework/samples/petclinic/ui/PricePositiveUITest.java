...
public class PricePositiveUITest {
	...
	@Test
	public void testPricePositiveUI() throws Exception {
		...
		this.driver.findElement(By.id("diagnosis.description")).sendKeys("desc");
		this.driver.findElement(By.xpath("//div[@id='list-diagnosis']/div[2]/span/span/span")).click();
		...
		this.driver.findElement(By.id("receipt.price")).sendKeys("10");
		this.driver.findElement(By.xpath("//button[@type='submit']")).click();
		Assert.assertEquals("COMPLETED", this.driver.findElement(By.xpath("//table[@id='ownersTable']/tbody/tr[2]/td[4]/span")).getText());
	}

...
public class MedicinesNegativeUITest {
	...
	@Test
	public void testMedicinesNegativeUI() throws Exception {
		...
		Assert.assertEquals("No hay datos", this.driver.findElement(By.xpath("//table[2]/tbody/tr/td")).getText());
	}

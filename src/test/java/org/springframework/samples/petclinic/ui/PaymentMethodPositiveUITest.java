...
public class PaymentMethodPositiveUITest {
	...
	@Test
	public void testPaymentMethodPositiveUI() throws Exception {
	    ...
	    driver.findElement(By.id("user.username")).sendKeys("pepegotera1");
	    driver.findElement(By.id("user.password")).clear();
	    driver.findElement(By.id("user.password")).sendKeys("pepegotera1");
	    driver.findElement(By.xpath("//button[@type='submit']")).click();
	    driver.findElement(By.linkText("Área clientes")).click();
	    driver.findElement(By.id("username")).click();
	    driver.findElement(By.id("username")).clear();
	    driver.findElement(By.id("username")).sendKeys("pepegotera1");
	    driver.findElement(By.id("password")).click();
	    driver.findElement(By.id("password")).clear();
	    driver.findElement(By.id("password")).sendKeys("pepegotera1");
	    driver.findElement(By.xpath("//button[@type='submit']")).click();
	    ...
	    driver.findElement(By.name("exp-date")).sendKeys("04 / 22");
	    driver.findElement(By.name("cvc")).clear();
	    driver.findElement(By.name("cvc")).sendKeys("422");

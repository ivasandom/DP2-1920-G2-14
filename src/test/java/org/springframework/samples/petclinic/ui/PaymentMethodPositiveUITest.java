...
public class PaymentMethodPositiveUITest {
	...
	public void testPaymentMethodPositiveUI() throws Exception {
		...
		this.driver.findElement(By.id("user.username")).sendKeys("pepegotera1");
		this.driver.findElement(By.id("user.password")).clear();
		this.driver.findElement(By.id("user.password")).sendKeys("pepegotera1");
		this.driver.findElement(By.xpath("//button[@type='submit']")).click();
		this.driver.findElement(By.linkText("Área clientes")).click();
		this.driver.findElement(By.id("username")).click();
		this.driver.findElement(By.id("username")).clear();
		this.driver.findElement(By.id("username")).sendKeys("pepegotera1");
		this.driver.findElement(By.id("password")).click();
		this.driver.findElement(By.id("password")).clear();
		this.driver.findElement(By.id("password")).sendKeys("pepegotera1");
		this.driver.findElement(By.xpath("//button[@type='submit']")).click();

...
public class SpecialtyElectionPositiveUITest {
	...
	public void testSpecialtyElectionNegativeUI() throws Exception {
		...
		this.driver.findElement(By.xpath("//div/div")).click();
		Assert.assertEquals("Professional", this.driver.findElement(By.xpath("//form[@id='appointment']/div/div[3]/label")).getText());
	}

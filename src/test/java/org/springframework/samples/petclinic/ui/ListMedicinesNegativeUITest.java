...
public class ListMedicinesNegativeUITest {
	...
	public void testListMedicinesNegativeUI() throws Exception {
		...
		this.driver.get("http://localhost:" + this.port + "/appointments/50/consultation");
		Assert.assertEquals("Whitelabel Error Page", this.driver.findElement(By.xpath("//h1")).getText());
	}

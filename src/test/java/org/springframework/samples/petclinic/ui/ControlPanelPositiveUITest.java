...
public class ControlPanelPositiveUITest {
	...
	@Test
	public void testControlPanelPositiveUI() throws Exception {
		...
		driver.findElement(By.id("email")).sendKeys("ortegaygasset@gmail.com");
		driver.findElement(By.id("user.username")).click();
		driver.findElement(By.id("user.username")).clear();
		driver.findElement(By.id("user.username")).sendKeys("ortegaygasset");
		driver.findElement(By.id("user.password")).click();
		driver.findElement(By.id("user.password")).clear();
		driver.findElement(By.id("user.password")).sendKeys("ortegaygasset");
		driver.findElement(By.xpath("//button[@type='submit']")).click();
		assertEquals("Ortega Y Gasset", driver.findElement(By.linkText("Ortega Y Gasset")).getText());
	}

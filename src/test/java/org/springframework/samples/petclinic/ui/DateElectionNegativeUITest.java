...
public class DateElectionNegativeUITest {
	...
	@Test
	public void testDateElectionNegativeUI() throws Exception {
		...
		this.driver.findElement(By.id("date")).sendKeys("10/10/2019");
		this.driver.findElement(By.id("startTime")).click();
		new Select(this.driver.findElement(By.id("startTime"))).selectByVisibleText("08:00:00");
		this.driver.findElement(By.id("startTime")).click();

...
public class ProfessionalSearchPositiveUITest {
	...
	@Test
	public void testProfessionalSearchPositiveUI() throws Exception {
		...
		this.driver.findElement(By.xpath("//button[@type='submit']")).click();
		Assert.assertEquals("Guillermo", this.driver.findElement(By.xpath("//table[@id='ownersTable']/tbody/tr/td")).getText());
	}

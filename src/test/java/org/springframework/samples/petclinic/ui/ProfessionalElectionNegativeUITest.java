...
public class ProfessionalElectionNegativeUITest {
	...
	@Test
	public void testProfessionalElectionNegativeUI() throws Exception {
		...
		new Select(this.driver.findElement(By.id("center"))).selectByVisibleText("Cadiz");

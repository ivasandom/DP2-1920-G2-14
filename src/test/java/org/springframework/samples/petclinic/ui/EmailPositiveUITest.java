...
public class EmailPositiveUITest {
	...
	@Test
	public void testEmailPositiveUI() throws Exception {
		...
		this.driver.findElement(By.id("firstName")).sendKeys("Luís");
		...
		this.driver.findElement(By.id("email")).sendKeys("luis@gmail.com");
		this.driver.findElement(By.id("user.username")).click();
		this.driver.findElement(By.id("user.username")).clear();
		this.driver.findElement(By.id("user.username")).sendKeys("luisperez");
		this.driver.findElement(By.id("user.password")).click();
		this.driver.findElement(By.id("user.password")).clear();
		this.driver.findElement(By.id("user.password")).sendKeys("luisperez");
		this.driver.findElement(By.xpath("//button[@type='submit']")).click();
		this.driver.findElement(By.linkText("> Citación online")).click();
		this.driver.findElement(By.id("username")).click();
		this.driver.findElement(By.id("username")).clear();
		this.driver.findElement(By.id("username")).sendKeys("luisperez");
		this.driver.findElement(By.id("password")).click();
		this.driver.findElement(By.id("password")).clear();
		this.driver.findElement(By.id("password")).sendKeys("luisperez");
		this.driver.findElement(By.xpath("//button[@type='submit']")).click();
		Assert.assertEquals("luisperez", this.driver.findElement(By.xpath("//div[@id='navbarSupportedContent']/ul[2]/li/a")).getText());
	}

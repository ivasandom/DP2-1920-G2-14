...
public class SpecialtyElectionNegativeUITest {
	...
	public void testSpecialtyElectionNegativeUI() throws Exception {
	    ...
	    driver.findElement(By.xpath("//form[@id='appointment']/p")).click();
	    assertEquals("No hay profesionales con esos parÃ¡metros.", driver.findElement(By.xpath("//form[@id='appointment']/p")).getText());
	}

                ...
                <div class="form-group has-feedback">
                    ...
                    <spring:bind path="center">
	                    <div class="form-group">
	                        ...
	                        <form:select class="form-control ${status.error ? 'is-invalid' : ''} ${valid ? 'is-valid' : ''}" id="center" path="center">
                    ...
                    <spring:bind path="specialty">
	                    <div class="form-group">
	                        ...
	                        <form:select class="form-control ${status.error ? 'is-invalid' : ''} ${valid ? 'is-valid' : ''}" id="specialty" path="specialty">
                    ...
                    <div class="form-group professionalGroup" style="display: none;">
                        <label for="id-professional ${status.error ? 'is-invalid' : ''} ${valid ? 'is-valid' : ''}">Professional</label>
                    ...
                    <div id="appointment-date-group" style="display: none;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control ${status.error ? 'is-invalid' : ''} ${valid ? 'is-valid' : ''}" id="date" name="date" placeholder="Choose date">
							<c:if test="${status.error}">
								<div class="invalid-feedback">
									${status.errorMessage}
								</div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control ${status.error ? 'is-invalid' : ''} ${valid ? 'is-valid' : ''}" name="startTime" id="startTime">

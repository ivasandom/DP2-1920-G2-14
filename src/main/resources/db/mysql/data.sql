...
INSERT INTO clients (id,birth_date,document,document_type,email,first_name,last_name,registration_date,health_card_number,health_insurance,username, stripe_id)

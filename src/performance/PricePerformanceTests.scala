...
class PricePerformanceTests extends Simulation {
...
object NewConsultation1 {
	...
	val price1Snc = scenario("PricePos").exec(Home.home,
														Login.login,
														ListAppointments.listAppointments,
														Consultation.consultation,
														NewConsultation1.newConsultation1
														)
	val price2Snc = scenario("PriceNeg").exec(Home.home,
														Login.login,
														ListAppointments.listAppointments,
														Consultation.consultation,
	...
	setUp(
		price1Snc.inject(rampUsers(5000) during (60 seconds)),
		price2Snc.inject(rampUsers(5000) during (60 seconds))
